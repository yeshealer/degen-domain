        ...
        <Element name='buy' className='w-full flex justify-center bg-[#E5E5E5] relative'>
            <Content>
                ...
                <div className='grid grid-cols-2 gap-5 mt-20 relative'>
                    {HowToBuy.map((process, index) => {
                        return (
                            <div className='border-2 border-[#166534] bg-white p-10 rounded-xl flex flex-col overflow-hidden shadow-xl relative' key={process.title}>
                                <div className={`text-white font-["bamboo"] text-2xl xl:text-3xl font-bold dashboard-title w-4/5 ${index % 2 === 1 ? 'text-end self-end' : 'text-start self-start'}`}>{process.title}</div>
                                <div className={`text-stone-700 text-lg xl:text-xl font-["bamboo"] mt-5 w-4/5 ${index % 2 === 1 ? 'text-end self-end' : 'text-start self-start'}`}>{process.description}</div>
                    ...
                    <div className='w-[300px] xl:w-[350px] h-[300px] xl:h-[350px] 2xl:w-[370px] 2xl:h-[370px] border border-[#166534] rounded-full p-10 absolute bg-[#e5e5e5] left-[300px] xl:left-[400px] 2xl:left-[515px] top-44 xl:top-24 2xl:top-12'>
                        <Player
                            autoplay
                            loop
