...
export default function MintNowBtn(props) {
    return (
        <button class="rounded-xl relative inline-flex group items-center justify-center px-10 py-3 m-1 cursor-pointer border-b-4 border-l-2 active:border-purple-600 active:shadow-none shadow-lg bg-gradient-to-tr from-purple-600 to-purple-500 border-purple-700 text-lg md:text-xl lg:text-2xl text-white font-['bamboo'] mt-10">
