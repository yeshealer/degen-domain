...
export default function index() {
    const ProjectDetail = wrapn('div')`
        text-stone-700 text-2xl lg:text-3xl font-["bamboo"] font-thin border-2 rounded-xl w-full sm:w-3/5 md:w-60 lg:w-72 2xl:w-80 relative p-3 lg:p-5 bg-white overflow-hidden
    `
                ...
                <div className='block sm:flex items-start'>
                    <div className='w-full sm:w-[30%]'>
                        <Player
                            ...
                            className='w-[220px] sm:w-[180px] md:w-[240px] lg:w-[300px] w-[220px] sm:h-[180px] md:h-[240px] lg:h-[300px]'
                        />
                    </div>
