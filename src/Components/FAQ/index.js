        ...
        <div className='w-full flex justify-center bg-[#E5E5E5] relative'>
            <div className='w-[1400px] text-black py-20 border-b-4 border-[#77e2924d] relative flex flex-col items-center'>
                ...
                <div className='mt-10 w-full flex flex-col items-center'>
                    {FAQs.map((faq, index) => {
                        return (
                            <div className='w-[70%] text-4xl text-stone-900 font-["Panda-font"] text-start bg-white p-5 rounded-xl drop-shadow-xl faq-content cursor-pointer mt-7' onClick={() => handleFAQ(index)}>
