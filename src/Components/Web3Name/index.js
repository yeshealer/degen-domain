    ...
    return (
        <Element name='web3name' className='w-full bg-[#e5e5e5] flex justify-center'>
            <Content>
                ...
                <div className='font-["bamboo"] max-w-5xl text-lg lg:text-xl xl:text-2xl text-center font-thin mt-10 text-stone-700 leading-7 lg:leading-10'>No more sandboxed usernames. Own your username, store an avatar and other profile data, and use it across services.</div>
                <div className='w-full flex justify-center'>
                    <div className='flex gap-5 items-center border border-[#77e2924d] px-10 py-2 rounded-full mt-10 bg-white'>
                        ...
                        <div className='font-["bamboo"] text-2xl lg:text-3xl text-green-900'>panda.degen</div>
                    </div>
                </div>
                <div className='absolute bottom-0 right-5'>
                    <Player
                        ...
                        className='w-[180px] h-[180px] lg:w-[240px] h-[240px]'
                    />
                </div>
