    ...
    return (
        <Element name='web3name' className='w-full bg-[#e5e5e5] flex justify-center'>
            <Content>
                ...
                <div className='font-["bamboo"] max-w-5xl text-xl xl:text-2xl text-center font-thin mt-10 text-stone-700 leading-10'>No more sandboxed usernames. Own your username, store an avatar and other profile data, and use it across services.</div>
