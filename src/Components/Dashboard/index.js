        ...
        <div className='w-full flex justify-center overflow-hidden'>
            <div className='w-full w-4/5 py-10'>
                <div className='flex items-center'>
                    <div className='w-3/5 text-center text-[45px] lg:text-[60px] 2xl:text-[64px] font-["Panda-font"] text-white leading-[50px] lg:leading-[70px] 2xl:leading-[100px]'>
                    ...
                    <div className='w-2/5'>
                        <Player
                            ...
                            className='w-[400px] lg:w-[500px] 2xl:w-[600px] h-[400px] lg:h-[500px] 2xl:h-[600px]'
                        />
                    </div>
                </div>
