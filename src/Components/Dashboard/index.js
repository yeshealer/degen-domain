        ...
        <div className='w-full flex justify-center overflow-hidden'>
            <div className='w-full w-4/5 py-10'>
                <div className='flex items-center'>
                    <div className='w-full sm:w-3/5 text-center text-[36px] md:text-[40px] lg:text-[60px] 2xl:text-6xl font-["Panda-font"] text-white leading:[40px] md:leading-[50px] lg:leading-[70px] 2xl:leading-[100px]'>
